...
Window_MapStatus.prototype.refresh = function () {
  ...
  this.drawActorName($gameActors.actor(1), 156, 0)
  this.drawActorLevel(150, 48, 80)
  this.drawActorExp($gameActors.actor(1), 0, 150, 288)
  ...
  this.drawIcon(320, 0, 158 + 44 * 4, 144, '黄钥匙', $gameParty.numItems($dataItems[2]))
  this.drawIcon(321, 144, 158 + 44 * 4 , 144, '蓝钥匙',  $gameParty.numItems($dataItems[3]))
  this.drawIcon(322, 0, 158 + 44 * 5, 144, '红钥匙',  $gameParty.numItems($dataItems[4]))
  this.drawIcon(323, 144, 158 + 44 * 5, 144, '绿钥匙',  $gameParty.numItems($dataItems[5]))
