...
Window_SaveInfo.prototype.drawData = function (data, dx, dy, dw) {
  ...
  } else if (data.match(/ITEM[ ](\d+)/i)) {
    this.drawItem(parseInt(RegExp.$1), dx, dy, dw)
...
Window_SaveInfo.prototype.drawExp = function (dx, dy, dw) {
  var text =
    $gameActors.actor(1).currentExp() - $gameActors.actor(1).currentLevelExp()
  this.changeTextColor(this.systemColor())
  this.drawText('经验', dx, dy, dw, 'left')
...
Window_SaveInfo.prototype.drawItem = function (id, dx, dy, dw) {
